...
<Page title="Catalog" subtitle="Services, owners, and what depends on what">
	<div class="flex flex-col gap-3.5">
		<div class="flex items-center">
			...
			<Button size="sm" href={ws('/catalog?new')}>
		...
		{#if !data.anyService}
			...
			>
				...
				<Button variant="secondary" size="sm" href={ws('/catalog?new')}>
					<PlusIcon data-icon="inline-start" />
...
<EditDialog bind:open service={data.dialog.service} teams={data.teams} error={form?.error} />
