...
func newTestRouter(t *testing.T) http.Handler {
	...
	h := dashboard.New(cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, config.Ingest{})
	return NewRouter(slog.New(slog.DiscardHandler), cfg, config.Ingest{}, nil, nil, nil, nil, nil, nil, nil, h)
}
