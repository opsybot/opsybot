...
type handler struct {
	...
	notifications service.NotificationRules
	chats         service.Chats
...
func New(cfg config.Auth, auth service.Auth, workspaces service.Workspaces, members service.Members, users service.Users, channels service.Channels, teams service.Teams, schedules service.Schedules, apikeys service.APIKeys, audits service.Audits, sso service.SSO, alerts service.Alerts, sources service.AlertSources, routes service.AlertRoutes, silences service.Silences, monitors service.AlertMonitors, escalations service.Escalations, notifications service.NotificationRules, chats service.Chats, incidents service.Incidents, services service.Services, cfgIngest config.Ingest) api.StrictServerInterface {
	return &handler{cfg: cfg, auth: auth, workspaces: workspaces, members: members, users: users, channels: channels, teams: teams, schedules: schedules, apikeys: apikeys, audits: audits, sso: sso, alerts: alerts, sources: sources, routes: routes, silences: silences, monitors: monitors, escalations: escalations, notifications: notifications, chats: chats, incidents: incidents, services: services, ingestBaseURL: cfgIngest.BaseURL}
}
