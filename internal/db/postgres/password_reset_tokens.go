...
var PasswordResetTokenTableColumns = struct {
	...
	RequestIP: "password_reset_tokens.request_ip",
...
var PasswordResetTokenWhere = struct {
	...
	ID:        whereHelperstring{field: "\"password_reset_tokens\".\"id\""},
	UserID:    whereHelperstring{field: "\"password_reset_tokens\".\"user_id\""},
	TokenHash: whereHelperstring{field: "\"password_reset_tokens\".\"token_hash\""},
	ExpiresAt: whereHelpertime_Time{field: "\"password_reset_tokens\".\"expires_at\""},
	UsedAt:    whereHelpernull_Time{field: "\"password_reset_tokens\".\"used_at\""},
	RequestIP: whereHelpernull_String{field: "\"password_reset_tokens\".\"request_ip\""},
...
var (
	passwordResetTokenAllColumns            = []string{"id", "user_id", "token_hash", "expires_at", "used_at", "request_ip", "created_at"}
	passwordResetTokenColumnsWithoutDefault = []string{"user_id", "token_hash", "expires_at"}
	passwordResetTokenColumnsWithDefault    = []string{"id", "used_at", "request_ip", "created_at"}
	passwordResetTokenPrimaryKeyColumns     = []string{"id"}
...
func (q passwordResetTokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*PasswordResetToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbpostgres: failed to execute a one query for password_reset_tokens")
	}
...
func (q passwordResetTokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (PasswordResetTokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbpostgres: failed to assign all query results to PasswordResetToken slice")
	}
...
func (q passwordResetTokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to count password_reset_tokens rows")
	}
...
func (q passwordResetTokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbpostgres: failed to check if password_reset_tokens exists")
	}
...
func (passwordResetTokenL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybePasswordResetToken any, mods queries.Applicator) error {
...
func FindPasswordResetToken(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*PasswordResetToken, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"password_reset_tokens\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbpostgres: unable to select from password_reset_tokens")
	}

	if err = passwordResetTokenObj.doAfterSelectHooks(ctx, exec); err != nil {
		return passwordResetTokenObj, err
	}
...
func (o *PasswordResetToken) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbpostgres: no password_reset_tokens provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbpostgres: unable to insert into password_reset_tokens")
	}
...
func (o *PasswordResetToken) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbpostgres: unable to update password_reset_tokens, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to update password_reset_tokens row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to get rows affected by update for password_reset_tokens")
	}
...
func (q passwordResetTokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to update all for password_reset_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to retrieve rows affected for password_reset_tokens")
	}
...
func (o PasswordResetTokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to update all in passwordResetToken slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to retrieve rows affected all in update all passwordResetToken")
	}
	return rowsAff, nil
}
...
func (o *PasswordResetToken) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("dbpostgres: no password_reset_tokens provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbpostgres: unable to upsert password_reset_tokens, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(passwordResetTokenPrimaryKeyColumns) == 0 {
				return errors.New("dbpostgres: unable to upsert password_reset_tokens, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "dbpostgres: unable to upsert password_reset_tokens")
	}
...
func (o *PasswordResetToken) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbpostgres: no PasswordResetToken provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to delete from password_reset_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to get rows affected by delete for password_reset_tokens")
	}
...
func (q passwordResetTokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbpostgres: no passwordResetTokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to delete all from password_reset_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: failed to get rows affected by deleteall for password_reset_tokens")
	}
...
func (o PasswordResetTokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbpostgres: unable to delete all from passwordResetToken slice")
	}
...
func (o *PasswordResetToken) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindPasswordResetToken(ctx, exec, o.ID)
	if err != nil {
		return err
	}
...
func (o *PasswordResetTokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbpostgres: unable to reload all in PasswordResetTokenSlice")
	}
...
func PasswordResetTokenExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"password_reset_tokens\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbpostgres: unable to check if password_reset_tokens exists")
	}
...
func (o *PasswordResetToken) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return PasswordResetTokenExists(ctx, exec, o.ID)
}
