...
type EscalationRun interface {
	...
	MarkAcked(ctx context.Context, workspaceID, alertID string, ackedAt, expiresAt time.Time) (bool, error)
	MarkResolved(ctx context.Context, workspaceID string, alertIDs []string, at time.Time) (int, error)
